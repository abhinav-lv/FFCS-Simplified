            ...
            <Wrap marginTop='15px'>
                <WrapItem>
                    <Box width='130px' bg='blue.50' padding='15px 25px 20px 15px' borderRadius='5px'>
                        ...
                        <Text fontWeight='semibold' fontSize='15px'>{'20'+(user.class)}</Text>
                    </Box>
                </WrapItem>
                <WrapItem>
                    <Box width='130px' bg='red.50' padding='15px 25px 20px 15px' borderRadius='5px'>
                        ...
                        <Text fontWeight='semibold' fontSize='15px'>{user.school.toUpperCase()}</Text>
                    </Box>
                </WrapItem>
                <WrapItem>
                ...
                <WrapItem>
                    <Box width='130px' bg='green.50' padding='15px 25px 20px 15px' borderRadius='5px'>
                        ...
                        <Text fontWeight='semibold' fontSize='15px'>{courses.length}</Text>
                    </Box>
                </WrapItem>
            </Wrap>
        </Box>
